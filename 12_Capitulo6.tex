...
El pasante se aseguró de que el nombre de este campo fuese suficientemente específico para evitar conflictos con el modelo a auditar, porque si poseen el mismo nombre podría ocurrir algún error en el sistema “Host". Se utilizó el nombre “\_turpial\_user" y está documentado en la librería para alertar al programador que la use.
...
Lo primero que se hizo fue construir un archivo llamado “setup.py", que contiene la información de la librería, el nombre (“turpial\_auditor”), la versión, los autores, la licencia y los paquetes que requiere, entre otros. En el caso de “turpial\_auditor”, el paquete requerido fue Jsonfield.\\
